      ...
      <Fade delay={delay}>
        <div className={styles.projectContainer}>
          <div className={styles.links}>
            <a className={styles.link} target="_blank" href={project.github}><FontAwesomeIcon icon={faGithub} /></a>
            <a className={styles.link} target="_blank" href={project.live}><FontAwesomeIcon icon={faExternalLinkAlt} /></a>
          </div>
